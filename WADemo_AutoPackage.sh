...
pro_path="/Users/lpw/Documents/gamehollywood/git/gitdemo/4.4.0/demo-iOS/WADemo.xcworkspace"

# ⚠️自动上传蒲公英(uKey、_api_key)获取地址https://www.pgyer.com/doc/api#uploadApp
api_key="" # 不上传则不填 
ukey=""  # 不上传则不填 
pgy_installType=2   # 1、公开发布 2、密码安装
pgy_password="123456"     # 如果设置了密码安装则需要密码
...
# Archive操作
xcodebuild archive -${pro_clean} ${pro_full_name} -scheme ${pro_name} -archivePath ${archive_path} -destination 'generic/platform=iOS'
